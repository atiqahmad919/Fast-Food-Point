  ...
  final List<Food> _menu = [
    ...
    Food(
      ...
      availableAddons: [
        ...
        Addon(name: 'Steak', price: 200),
        Addon(name: "Avocado", price: 300)
      ],
    ),
    Food(
      name: 'Fat Burger',
    ...
    Food(
      ...
      availableAddons: [
        ...
        Addon(name: "Cinnamon Spice", price: 300)
      ],
    ),
    Food(
    ...
    Food(
      ...
      availableAddons: [
        Addon(name: 'Sour Cream', price: 100),
        Addon(name: 'Pico de Gallo', price: 200),
        Addon(name: "Guacamole", price: 300)
      ],
    ),
    Food(
    ...
    Food(
      ...
      availableAddons: [
        Addon(name: 'Cheese Sauce', price: 100),
        Addon(name: 'Truffle Oil', price: 200),
        Addon(name: 'Cajun Spice', price: 300),
      ],
    ),
    Food(
